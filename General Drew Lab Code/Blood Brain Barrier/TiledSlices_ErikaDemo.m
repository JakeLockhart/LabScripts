...
ImageStacks = cell(1, ImageSets);  % Preallocate cell array

for setIdx = 1:ImageSets
    ImageStacks{setIdx} = uint8(255 * rand([ImageSize, ImageSlice]));
end

[ImageInfo, FigureWindow] = TiledSliceViewer(ImageStacks, 3)
